# 💫 About Me:
QA Engineer with 10+ years in IT (since 2015).<br/>
I combine a strong technical background in system administration and team leadership with hands-on QA expertise.<br/>
<br/>
**My focus areas:**<br/>
• Manual functional & regression testing (Web, Desktop, Backend)<br/>
• Automation testing with Python (PyTest, Selenium, Requests)<br/>
• Load & performance testing (JMeter, simulating up to 500 concurrent users)<br/>
• Complex SQL queries (JOINs, subqueries) for data validation<br/>
• Full defect lifecycle management in Jira<br/>
<br/>
